...
import com.sponsorbridge.entity.ConversationMessage;
import com.sponsorbridge.entity.MessageStatus;
...
public interface ConversationMessageRepository extends JpaRepository<ConversationMessage, Long> {
    ...
    List<ConversationMessage> findByConversationIdAndType(@Param("conversationId") Long conversationId, @Param("type") com.sponsorbridge.entity.MessageType type);
}
