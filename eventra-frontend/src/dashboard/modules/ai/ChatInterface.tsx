...
const WELCOME_MESSAGE: ChatMessage = {
  ...
  role: 'assistant',
  content:
    "Hello! I'm your AI Assistant. I can help you find ideal sponsors, optimize your event listings, analyze market trends, and draft professional proposals. What would you like to work on today?",
