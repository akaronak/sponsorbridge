        ...
        <div className="bg-slate-900/50 backdrop-blur-xl border border-slate-800 rounded-2xl p-12">
          ...
          <div className="space-y-8 text-slate-300">
            <section>
              ...
              <p>
                {BRAND.legalEntity} ("we", "our", or "us") operates the {BRAND.name} website and application. This page informs you of our policies regarding the collection, use, and disclosure of personal data when you use our Service.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                You have the right to access, correct, or delete your personal data. You may also request a copy of your data or restrict our processing. To exercise these rights, please contact us at {BRAND.privacyEmail}.
              </p>
            </section>

            <div className="mt-12 p-6 bg-slate-800/50 rounded-lg border border-slate-700">
              <p className="text-sm">
                For questions about this Privacy Policy, contact us at <a href={`mailto:${BRAND.privacyEmail}`} className="text-indigo-400 hover:text-indigo-300">{BRAND.privacyEmail}</a>
              </p>
            </div>
          </div>
        </div>
