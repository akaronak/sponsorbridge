...
class FileUploadServiceTest {
    ...
    void testUploadValidPdfFile() throws IOException {
        ...
        uploadResult.put("secure_url", "https://res.cloudinary.com/demo/image/upload/v1234567890/eventra/proposals/file.pdf");
        ...
        assertEquals("https://res.cloudinary.com/demo/image/upload/v1234567890/eventra/proposals/file.pdf", result);
    ...
    void testUploadSmallFile() throws IOException {
        ...
        Map<String, Object> uploadResult = new HashMap<>();
        uploadResult.put("secure_url", "https://res.cloudinary.com/demo/image/upload/v1234567890/eventra/proposals/small.pdf");
        when(uploader.upload(eq(fileContent), any(Map.class))).thenReturn(uploadResult);
        ...
        // Assert
        assertNotNull(result);
        assertEquals("https://res.cloudinary.com/demo/image/upload/v1234567890/eventra/proposals/small.pdf", result);
    }
}
